<script>
     ...
     * 
     * @param {Object} mupdf Object representing MuPdf.Instance from createMuPdf method
     * @param {Number} pdf Number representing MuPdf.DocumentHandle from MuPdf.Instance.load method
