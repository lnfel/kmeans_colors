...
<main class="lg:px-[3rem]">
    <section class="py-4 space-y-8">
        ...
        <div class="space-y-4">
            {#each $page.data?.artifactCollection?.artifacts ?? [] as artifact, artifactIndex}
                {#each Array.from({ length: artifact.pages }) as page, pageIndex}
                    <div class="grid place-items-center">
                        <figure class="space-y-2">
                            <!-- <img src={`/storage/aerial/${$page.data?.artifactCollection?.id}/${artifact.id}.png`} alt={artifact.label} class="mx-auto" /> -->
                            <img src={artifact.url.replace('.pdf', `_${pageIndex + 1}.png`)} alt={artifact.label} class="img-preview mx-auto" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        {#each artifact?.kmeansColors?.colors[pageIndex] ?? [] as pallete}
                            <div>
                        ...
                        <div class="py-4 space-y-4">
                            ...
                            <div class="cmyk-summary grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div class="cyan group relative flex items-center gap-2">
                                    ...
                                    <div class="value">{`${artifact.cmyk.info.summary[pageIndex].c.value}%`}</div>
                                    <div class="formula invisible group-hover:visible absolute bottom-[125%] whitespace-nowrap bg-slate-800 text-white dark:bg-white dark:text-slate-800 rounded px-2 py-0.5 after:content[''] after:absolute after:top-full after:left-1/2 after:border-8 after:border-solid after:border-transparent after:border-t-slate-800 after:dark:border-t-white">
                                        {artifact.cmyk.info.summary[pageIndex].c.formula}
                                    </div>
                                </div>
                                <div class="magenta group relative flex items-center gap-2">
                                    ...
                                    <div class="value">{`${artifact.cmyk.info.summary[pageIndex].m.value}%`}</div>
                                    <div class="formula invisible group-hover:visible absolute bottom-[125%] whitespace-nowrap bg-slate-800 text-white dark:bg-white dark:text-slate-800 rounded px-2 py-0.5 after:content[''] after:absolute after:top-full after:left-1/2 after:border-8 after:border-solid after:border-transparent after:border-t-slate-800 after:dark:border-t-white">
                                        {artifact.cmyk.info.summary[pageIndex].m.formula}
                                    </div>
                                </div>
                                <div class="yellow group relative flex items-center gap-2">
                                    ...
                                    <div class="value">{`${artifact.cmyk.info.summary[pageIndex].y.value}%`}</div>
                                    <div class="formula invisible group-hover:visible absolute bottom-[125%] whitespace-nowrap bg-slate-800 text-white dark:bg-white dark:text-slate-800 rounded px-2 py-0.5 after:content[''] after:absolute after:top-full after:left-1/2 after:border-8 after:border-solid after:border-transparent after:border-t-slate-800 after:dark:border-t-white">
                                        {artifact.cmyk.info.summary[pageIndex].y.formula}
                                    </div>
                                </div>
                                <div class="key group relative flex items-center gap-2">
                                    ...
                                    <div class="value">{`${artifact.cmyk.info.summary[pageIndex].k.value}%`}</div>
                                    <div class="formula invisible group-hover:visible absolute bottom-[125%] whitespace-nowrap bg-slate-800 text-white dark:bg-white dark:text-slate-800 rounded px-2 py-0.5 after:content[''] after:absolute after:top-full after:left-1/2 after:border-8 after:border-solid after:border-transparent after:border-t-slate-800 after:dark:border-t-white">
                                        {artifact.cmyk.info.summary[pageIndex].k.formula}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="color-distribution grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div class="flex items-center gap-2">
                                    <div class="w-20 text-slate-700 bg-white border border-slate-500 px-2 py-0.5">White</div> {artifact.cmyk.info.whiteSpace[pageIndex]}%
                                </div>
                                <div class="flex items-center gap-2">
                                    <div class="w-20 bg-gradient-to-br from-rose-500 via-violet-500 to-sky-500 text-white border border-slate-500 px-2 py-0.5">Colored</div> {artifact.cmyk.info.coloredSpace[pageIndex]}%
                                </div>
                            </div>
                        </div>
                    {/if}
